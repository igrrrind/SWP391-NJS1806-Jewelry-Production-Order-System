const policies = {
    termsAndConditions: [
      { id: 'policy-1', text: "The cost of a product is determined by the following formula: (Metal Price at Time Of Quote Creation × Product Weight) + Stone Cost + Labor Cost. Labor Cost includes our profit margin, design and any additional costs (see 5.)" },
